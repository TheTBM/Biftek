...
public class SpawnManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (player1.GetComponent<Info>().isDead())
        {
            numAlive -= 1;
        }

        if (player2.GetComponent<Info>().isDead())
        {
            numAlive -= 1;
        }

        if (player3.GetComponent<Info>().isDead())
        {
            numAlive -= 1;
        }

        if (player4.GetComponent<Info>().isDead())
        {
            numAlive -= 1;
        }

        if (!player1.isAlive() && !player1.GetComponent<Info>().isDead())
        {
        ...
        if (!player2.isAlive() && !player2.GetComponent<Info>().isDead())
        {
        ...
        if (!player3.isAlive() && !player3.GetComponent<Info>().isDead())
        {
        ...
        if (!player4.isAlive() && !player4.GetComponent<Info>().isDead())
        {
